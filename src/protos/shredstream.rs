...
pub mod shredstream_client {
    ...
    impl ShredstreamClient<tonic::transport::Channel> {
        ...
        /// # Errors
        ///
        /// Returns `tonic::transport::Error` if connection fails or endpoint is invalid.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// # Errors
        ///
        /// Returns `tonic::Status` if service is not ready or unary request fails.
...
pub mod shredstream_server {
    ...
    impl<T> ShredstreamServer<T> {
        ...
        pub fn from_arc(inner: Arc<T>) -> Self {
            Self {
                inner,
                accept_compression_encodings: tonic::codec::EnabledCompressionEncodings::default(),
                send_compression_encodings: tonic::codec::EnabledCompressionEncodings::default(),
...
pub mod shredstream_proxy_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Subscribe to entries from the proxy
        ///
        /// # Errors
        ///
        /// Returns `tonic::Status` if service is not ready or streaming request fails.
